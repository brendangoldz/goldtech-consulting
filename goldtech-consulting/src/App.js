      ...
      <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start space-x-4">
            ...
            <a href="https://github.com/brendangoldz" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg border border-gray-600 hover:border-gold hover:bg-gold/10 transition-all duration-300">
              <FaGithub className="text-gray-300 hover:text-gold transition-colors" />
            </a>
            <a href="https://www.upwork.com/freelancers/~014de678477c7c319c?mp_source=share" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg border border-gray-600 hover:border-gold hover:bg-gold/10 transition-all duration-300">
