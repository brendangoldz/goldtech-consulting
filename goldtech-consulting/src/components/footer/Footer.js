        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-center space-x-4">
            {contact.socialLinks.linkedin && (
              <a href={contact.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg border border-gray-600 hover:border-gold hover:bg-gold/10 transition-all duration-300" aria-label="Connect on LinkedIn">
                <FaLinkedin className="text-gray-300 hover:text-gold transition-colors" />
              </a>
            )}
            {contact.socialLinks.github && (
              <a href={contact.socialLinks.github} target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg border border-gray-600 hover:border-gold hover:bg-gold/10 transition-all duration-300" aria-label="View GitHub profile">
                <FaGithub className="text-gray-300 hover:text-gold transition-colors" />
              </a>
            )}
            {contact.socialLinks.upwork && (
              <a href={contact.socialLinks.upwork} target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg border border-gray-600 hover:border-gold hover:bg-gold/10 transition-all duration-300" aria-label="View Upwork profile">
