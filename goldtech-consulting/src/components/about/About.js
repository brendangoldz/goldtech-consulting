  ...
  <section id="about" className={`py-20 ${getSectionBg(variant, true)}`} aria-labelledby="about-title">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <div
            className={`${imageFrameClasses} rounded-2xl border p-2 flex w-full max-w-[20rem] sm:max-w-sm md:max-w-md xl:max-w-[33rem] aspect-square items-center justify-center overflow-hidden`}
          >
            <img
              src={content.image}
